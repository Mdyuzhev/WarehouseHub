// k6-kafka/scenarios/ramp-test-300vu.js
// Ramp-up тест: 0 → 300 VU с шагом 30 каждые 5 минут
// Финальный этап: 300 VU на 5 минут
// WH-217
...
// Ramp-up сценарий: 0 → 300 VU, шаг 30, каждые 5 минут
// Итого: 10 шагов * 5 мин = 50 мин + 5 мин на 300 VU = 55 мин
export const options = {
    scenarios: {
        ramp_up_300: {
            ...
            startVUs: 0,
            stages: [
                { duration: '5m', target: 30 },   // 0 → 30 VU
                { duration: '5m', target: 60 },   // 30 → 60 VU
                { duration: '5m', target: 90 },   // 60 → 90 VU
                { duration: '5m', target: 120 },  // 90 → 120 VU
                { duration: '5m', target: 150 },  // 120 → 150 VU
                { duration: '5m', target: 180 },  // 150 → 180 VU
                { duration: '5m', target: 210 },  // 180 → 210 VU
                { duration: '5m', target: 240 },  // 210 → 240 VU
                { duration: '5m', target: 270 },  // 240 → 270 VU
                { duration: '5m', target: 300 },  // 270 → 300 VU
