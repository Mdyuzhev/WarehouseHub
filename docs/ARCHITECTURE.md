...
**Технологии:** Java 17, Spring Boot 3.2, PostgreSQL, JWT, Kafka
...
│   ├── service/
│   │   ├── ProductService.java      # + Kafka events
...
| `warehouse.notifications` | Уведомления (LOW_STOCK, OUT_OF_STOCK) |
...
│   │   └── AnalyticsPage.vue   # Real-time аналитика (WH-121)
│   ├── services/
│   │   └── auth.js             # Аутентификация + API + permissions
│   ├── utils/
│   │   └── apiConfig.js        # Определение API URL
│   ├── router/
│   │   └── index.js            # Vue Router (5 роутов)
│   ├── App.vue                 # Навигация + роли
│   └── main.js
...
**Технологии:** Python 3.11, FastAPI, httpx
...
**Технологии:** Python 3.11, FastAPI, aiokafka, aioredis, WebSocket
...
| selenoid | 30040 | 4444 | http://192.168.1.74:30040 |
