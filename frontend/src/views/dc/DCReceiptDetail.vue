...
async function loadReceipt() {
  const result = await fetchDocument('/receipts', route.params.id)
  if (result.success) {
...
async function performAction(action) {
  ...
  const result = await updateDocument('/receipts', route.params.id, action)
...
async function confirmReceipt() {
  ...
  actionLoading.value = true
  const result = await updateDocument('/receipts', route.params.id, 'confirm', { items })
  actionLoading.value = false
