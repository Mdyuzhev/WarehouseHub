...
class Settings(BaseSettings):
    ...
    # CORS: разрешённые origins (через запятую, или * для development)
    # Пример: "https://wh-lab.ru,http://192.168.1.74:30081,http://192.168.1.74:31081"
    cors_allowed_origins: str = "https://wh-lab.ru,http://192.168.1.74:30081,http://192.168.1.74:31081,http://localhost:5173"
